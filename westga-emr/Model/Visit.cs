...
namespace westga_emr.Model
{
	...
	public class Visit
	{
		...
		/// <param name="symptoms_">Symptoms the patient exhibits during the Visit</param>
		/// <param name="finalDiagnosis_">The final diagnosis made during the Visit</param>
		public Visit( long? appointmentID_, int? nurseID_, DateTime visitDateTime_, 
			string initialDiagnosis_, decimal weight_, int systolicPressure_, int diastolicPressure_, 
			decimal bodyTemperature_, int pulse_, string symptoms_, string finalDiagnosis_) 
			: 
			this(null, appointmentID_, nurseID_, visitDateTime_, initialDiagnosis_, weight_, systolicPressure_, diastolicPressure_,
				bodyTemperature_, pulse_, symptoms_, finalDiagnosis_)
		{
		}
		...
		/// <param name="symptoms_">Symptoms the patient exhibits during the Visit</param>
		/// <param name="finalDiagnosis_">The final diagnosis made during the Visit</param>
		public Visit(long? appointmentID_, string initialDiagnosis_, decimal weight_, int systolicPressure_, int diastolicPressure_, decimal bodyTemperature_, int pulse_, string symptoms_, string finalDiagnosis_)
		{
